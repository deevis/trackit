...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { city: @station.city, code: @station.code, data: @station.data, name: @station.name, state: @station.state } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { city: @station.city, code: @station.code, data: @station.data, name: @station.name, state: @station.state } }
